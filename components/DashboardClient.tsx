    ...
    async function cargar() {
      try {
        const [sRes, mRes, cRes] = await Promise.all([
          ...
          fetch(`${SUPABASE_URL}/rest/v1/coincidencias_satelital?select=lugar_nombre,clase_dano,color_semaforo,reporte_lat,reporte_lng,area_m2&color_semaforo=in.(rojo,naranja)&order=area_m2.desc&limit=50`, { headers }),
        ])
